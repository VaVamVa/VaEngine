...
public:
	...
	ResourceView_DirectX(const ResourceViewDesc& inDesc, D3D12_CPU_DESCRIPTOR_HANDLE inCpuHandle, BaseRHIResource* inResource);
	...
	BaseRHIResource*		GetResource()	const override;
